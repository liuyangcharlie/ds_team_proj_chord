...
def index():
    ...
    return open(dir + "/index.html", 'r').read()

@request_map("/index.css")
def my_ctrl0():
    dir = os.path.dirname(os.path.realpath(__file__))
    return Headers({"content-type": "text/css"}), open(dir + "/index.css", 'r').read()

@request_map("/index.js")
def my_ctrl1():
    dir = os.path.dirname(os.path.realpath(__file__))
    return Headers({"content-type": "text/javascript"}), open(dir + "/index.js", 'r').read()
